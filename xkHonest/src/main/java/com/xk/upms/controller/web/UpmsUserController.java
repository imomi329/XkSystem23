...
//    private static final String DIR_INDEX = "/admin/upms/manage/user";
//    private static final String INDEX = DIR_INDEX + "list";
//    private static final String COMPILER = DIR_INDEX + "input";
...
//    @RequiresPermissions("upms:user:read")
    ...
    public String index(Model model) {
        ...
        model.addAttribute("system", "upms");
...
//    @RequiresPermissions("upms:user:role")
    ...
    public String role(@PathVariable("name") String name, Model model) {
        // 所有角色
        model.addAttribute("upmsRoles", upmsRoleService.list(null));
        // 用戶擁有角色
        model.addAttribute("upmsUserRoles", upmsRoleService.selectByName(name));
